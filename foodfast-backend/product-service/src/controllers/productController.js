...
// @desc    Lấy tất cả sản phẩm (Hỗ trợ lọc theo Branch, Category, Price)
// @route   GET /?branchId=...&keyword=...&category=...&minPrice=...&maxPrice=...
export const getAllProducts = async (req, res) => {
    try {
        const { branchId, keyword, category, minPrice, maxPrice } = req.query;
        ...
        // 4. Trường hợp KHÔNG chọn chi nhánh (Admin xem hoặc chưa chọn)
        if (!branchId) {
        ...
        // 5. Trường hợp CÓ chọn chi nhánh -> Tìm trong Inventory
