...
const OrderTrackingPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                if (['DRONE_ASSIGNED', 'DELIVERING', 'DELIVERED'].includes(data.status)) {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            ...
            <h1 className="text-3xl font-bold mb-4 text-center text-gray-800">Theo dõi đơn hàng #{orderId?.slice(-6)}</h1>
            ...
            <div className="flex flex-col items-center mb-6 space-y-2">
                ...
                <div className="text-xl font-medium text-gray-700">
                    Trạng thái: <span className="font-bold text-indigo-600 ml-2 animate-pulse">{orderStatus}</span>
                </div>
            </div>

            {/* Hiển thị Bản đồ hoặc Màn hình chờ */}
            <div className="mb-8 shadow-lg rounded-xl overflow-hidden border border-gray-200 bg-gray-50 relative" style={{ minHeight: "50vh" }}>
